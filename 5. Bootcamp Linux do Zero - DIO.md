...
4️⃣ Agora execute o “PuTTY”, na parte escrita “**Host Name (or IP address)**”, digite o endereço IP da sua máquina virtual do Virtual Box, para que você consiga realizar o acesso remoto desta máquina. **Atenção**: **Isso só irá funcionar se a sua máquina física** (no meu caso Windows) **estiver na mesma faixa de IP da MV**, para saber disso, você precisa abrir a sua Prompt de Comando, digite o comando “**ipconfig** + enter”, desça a barra de rolagem até encontrar “**Adaptador de Rede sem Fio Wi-Fi:**”, e confirme se o IP que consta em “**Endereço IPv4**”, se consta na mesma faixa de IP, para que você consiga realizar acesso remoto a ela. 

**Exemplo**: IPv4 **10.0.0.**191 (máquina física) e inet **10.0.0.**103/24 (máquina virtual).

**Atenção**: Caso não esteja na mesma faixa de IP, **A rede da máquina virtual deve estar/ser configurada como** “**bridge**”.

**Continuar de 5:05 minutos no vídeo da aula 1.. configurar a rede da máquina virtual para constar na mesma faixa de IP da máquina física para continuar os estudos.**