...
🔺**git restore nomedoarquivo** + enter = Remove as alterações que foram feitas e salvas no arquivo. Exemplo do comando: git restore '2. Comandos no GitBash.md' + enter.
